...
bool JointPositionExampleController::init(hardware_interface::RobotHW* robot_hardware,ros::NodeHandle& node_handle) 
{
  //参数服务器
...
{
  std::cout << "--------------start:JointPositionExampleController.12.4-19.32--------------"<< std::endl;
  for (size_t i = 0; i < 7; ++i) 
  {
